...
@Component({
  ...
  template: `
    <div class="p-2">
      @if (!!link()) {
      <a [routerLink]="link()" [ngClass]="fill()" class="items-center gap-2 relative inline-flex justify-center px-4 py-2 overflow-hidden font-medium rounded-lg group bg-white">
